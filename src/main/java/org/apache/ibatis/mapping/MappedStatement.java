...
public final class MappedStatement {
    ...
    //sql语句映射key，在命名空间中唯一的标识符，可以被用来引用这条语句。
    private String id;
    ...
    //这个设置仅针对嵌套结果 select 语句适用：如果为 true，就是假设包含了嵌套结果集或是分组，这样的话当返回一个主结果行的时候，
    ...
    //如果配置了数据库厂商标识（databaseIdProvider），MyBatis 会加载所有的不带 databaseId 或匹配当前 databaseId 的语句；
